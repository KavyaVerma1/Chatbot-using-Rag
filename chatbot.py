...
# Set up Pinecone and Groq API keys directly
pinecone_api_key = "pcsk_2zx6xp_58THUGHFh59B9aR3qzUNZhcV6LuGu6v4MALuvR5ERWpwe41GBuNeNXFXh7LDho3"
groq_api_key = "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"

if not pinecone_api_key or not groq_api_key:
    st.error("API keys for Pinecone and Groq are missing.")
    st.stop()
